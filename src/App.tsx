            ...
            >
              <span style={{ display: "block", marginBottom: "1.1em" }}>
                <strong style={{ color: "#fdf2f8", fontWeight: 800 }}>
                  Turn your shadowboxing and bagwork into dynamic, guided
                  sessions with spoken techniques and timed rounds.
                </strong>{" "}
              ...
              <span style={{ display: "block", marginBottom: "1.1em" }}>
                ...
                It does not provide feedback, so if you are unfamiliar with any
                of the techniques, it is highly recommended that you first learn
                them from a qualified coach.
              </span>
              <span style={{ display: "block", marginBottom: "1.1em" }}>
...
>
  ...
  {isPreRound && <div>Pre-Round Time Left: {fmtTime(preRoundTimeLeft)}</div>}
                    ...
                    */}
                    ...
                    {emphasisList.some(
                      (e) => selectedEmphases[e.key as EmphasisKey]
                    ) && (
                      <section
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          {(showAllEmphases
                            ? emphasisList
                            : emphasisList.slice(0, 9)
                          ).map((style) => {
                            const isSelected =
                              selectedEmphases[style.key as EmphasisKey];
                            return (
                              <button
                                key={style.key}
                                type="button"
                                ...
                                >
                                  <div>
                                    ...
                                    >
                                      ...
                                      >
                                        {techniques[style.key]?.title?.trim() ||
                                          style.label}
                                      </h3>
                                    </div>
                                    {style.desc && (
                        ...
                        <div style={{ marginBottom: "2rem" }}>
                          ...
                          >
                            ...
                            <div>
                              ...
                              >
                                Mirrors "Left" and "Right" in technique callouts
                            ...
                            <div>
                              ...
                              >
                                <input
                                  ...
                                  onChange={(e) =>
                                    setAddCalisthenics(e.target.checked)
                                  }
                                  style={{
                                    accentColor: "#60a5fa",
                                    width: 18,
                              ...
                              >
                                Adds bodyweight exercises like jumping jacks and
                                high knees to your workout
                              </p>
                            </div>
                            ...
                            <div>
                              ...
                              >
                                <input
                                  ...
                                  checked={readInOrder}
                                  onChange={(e) =>
                                    setReadInOrder(e.target.checked)
                                  }
                                  style={{
                                    accentColor: "#60a5fa",
                                    width: 18,
                              ...
                              >
                                Calls techniques sequentially instead of
                                randomly for structured practice
                              </p>
                            </div>
                          </div>
                        </div>
                        ...
                        <div>
                          ...
                          >
                            ...
                            {!voices.length && !ttsAvailable && (
                              ...
                              >
                                <strong>No text-to-speech available:</strong>{" "}
                                Your device may not support text-to-speech.
                              </div>
                            )}
                            {!voices.length && ttsAvailable && (
                              <div
                              ...
                              >
                                <strong>Voice loading:</strong> System voice
                        ...
                        >
                          ...
                          <button
                            ...
                            style={{
                              ...
                              boxShadow:
                                "0 12px 24px rgba(34,197,94,0.25), 0 6px 12px rgba(59,130,246,0.2), inset 0 1px 0 rgba(255,255,255,0.2)",
                            ...
                            onMouseEnter={(e) => {
                              ...
                              e.currentTarget.style.boxShadow =
                                "0 16px 32px rgba(34,197,94,0.35), 0 8px 16px rgba(59,130,246,0.3), inset 0 1px 0 rgba(255,255,255,0.3)";
                            }}
                            onMouseLeave={(e) => {
                              e.currentTarget.style.transform =
