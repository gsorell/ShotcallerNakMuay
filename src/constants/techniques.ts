...
> = {
  ...
  feints_and_fakeouts: {
    ...
    combos: [
      ...
      "Teep, Teep Feint, Right Kick",
      "Low Kick, Feint Low Kick, High Kick",
      "Body Kick, Feint Body Kick, 2 3 Low Kick",
      "Step in, Step Feint, Teep",
      "Retreat, Retreat Feint, 2 3 2",
      "Switch step, Double switch, Right Kick",
